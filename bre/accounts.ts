...
import { AccountNames, NamedAccounts } from './typeExtensions'
...
export async function getTestAccounts(
	...
	const namedAccounts = await getNamedAccounts(provider, bardsConfigPath)
